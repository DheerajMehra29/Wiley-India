    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        try (Connection connection = DriverManager.getConnection(url, user, password)) {
            ...
            try (Statement statement = connection.createStatement()) {
                ...
                String deleteSql = "DELETE FROM Worker WHERE WORKER_ID = 3";
...
Implement insertion
Implement reading a single record of a particular id for city table.
Write appropriate controller and model functions for those and demonstrate execution from App.java
